...
class SCConv(nn.Module):
    def __init__(
        self, inplanes, planes, stride, padding, dilation, groups, pooling_r, norm_layer
    ):
...
class SCBottleneck(nn.Module):
    ...
    expansion = 4
    pooling_r = (
        4  # down-sampling rate of the avg pooling layer in the K3 path of SC-Conv.
    )
    ...
    def __init__(
        ...
        self.conv3 = nn.Conv2d(group_width * 2, planes, kernel_size=1, bias=False)
