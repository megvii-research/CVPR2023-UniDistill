...
class Exp(BaseExp):
    def __init__(
        ...
        **kwargs
        ...
        camera_cfg = copy.deepcopy(self.model_cfg["camera_encoder"])
        self.model_cfg["camera_encoder"] = None
        self.teacher_model = BaseExp._configure_model(self)
        checkpoint = torch.load(
            "unidistill/exps/multisensor_fusion/nuscenes/BEVFusion/tmp/lidar_model.pth",
        ...
        self.model_cfg["camera_encoder"] = camera_cfg
    ...
    def training_step(self, batch):
        ...
        loss = (
            ...
            + 100 * (loss_feature)
            + 40 * loss_bev_rel
            + 10 * (loss_resp_cls + loss_resp_reg)
        )
        end_time = time.time()
        return loss
...
if __name__ == "__main__":
    ...
    run_cli(Exp, "BEVFusion_nuscenes_centerhead_camera_exp_distill_lidar")
